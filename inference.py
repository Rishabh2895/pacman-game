...
class InferenceModule:
    ...
    def getObservationProb(self, noisyDistance, pacmanPosition, ghostPosition, jailPosition):
        ...
        ghostPacmanDistance = manhattanDistance(pacmanPosition, ghostPosition)
        return busters.getObservationProbability(noisyDistance, ghostPacmanDistance)
...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for position in self.allPositions:
            prob = self.getObservationProb(observation, pacmanPos, position, jailPos)
            distribution[position] = prob * self.beliefs[position]
    ...
    def elapseTime(self, gameState):
        ...
        for oldPos in self.allPositions:
            ...
            for newPos in newPosDist.keys():
                distribution[newPos] += self.beliefs[oldPos] * newPosDist[newPos]
        self.beliefs = distribution
